...
| Machine | Role | OS | IP |
|---|---|---|---|
| DC01 | Domain controller, DNS | Windows Server 2022 Standard (Desktop Experience) | 192.168.10.1 (static) |
| Client01 | Domain-joined workstation | Windows 11 Pro | 192.168.10.10 (static) |
